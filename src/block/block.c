...
struct block_monitor_info *block_monitor_conf;
...
void add_monitoring_path(gpointer elem, gpointer not_used)
{
...
void register_monitoring_path(gpointer elem, gpointer not_used)
{
